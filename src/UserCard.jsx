...
<div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    ...
    <div class="flex flex-col items-center pb-10">
        <img class="w-24 h-24 mb-3 rounded-full shadow-lg" src={props.data.picture.large} alt="Bonnie image"/>
        <h5 class="mb-1 text-xl font-medium text-gray-900 dark:text-white">{props.data.name.first}{" "}{props.data.name.last}</h5>
        <p className="flex text-xl font-bold"><img src={email} alt="Setting svg" />{props.data.email}</p>
